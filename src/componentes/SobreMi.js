        ...
        <section className="sobremi">
            ...
            <section className="reseña">
                <div className='div-res'>
                    ...
                    <p>
                    Soy una mujer que no se cansa de aprender, terminé mis estudios de Producción de Televisión en el Poli JIC, luego me dediqué por mucho tiempo a trabajar en el área comercial, se me presentó la oportunidad de estudiar Desarrollo de Software con la alcaldía de Medellín y ahora estoy realizando un Diplomado con Academía Geek de React y Node.
                    </p>
                    <p>
